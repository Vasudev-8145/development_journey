...
create table product(
    ...
    category enum('electronics','clothing','books','gorceries') default 'electronics'
);
...
insert into product(name,stock,price,category) values('Wireless Mouse',50,1200.00,'electronics');
...
insert into product(name,stock,price,category) values('Cotton T-Shirt',120,850.00,'clothing');
...
insert into product(name,stock,price,category) values('SQL Guide Book',30,450.00,'books');
...
insert into product(name,stock,price,category) values('Organic Milk',15,60.00,'gorceries');
...
update product set price=1100.00 where id=1;

-- Q23. Change the category of the product with id 4 to 'clothing'.

update product set category='clothing' where id=4;

-- Q24. Change both price and stock for product with id 2:
--      price = 799.00
--      stock = 100

update product set price=799.00,stock=100 where id=2;
