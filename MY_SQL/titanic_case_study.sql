...
-- Survived: 0
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('John Smith',25,'male',3,7.25,0,'S');
...
-- Survived: 1
-- Embarked: C
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Mary Johnson',28,'female',1,71.28,1,'C');
...
-- Survived: 0
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('William Brown',35,'male',2,26.00,0,'S');
...
-- Survived: 1
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Anna Davis',22,'female',3,8.05,1,'S');
...
-- Survived: 1
-- Embarked: C
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Robert Wilson',40,'male',1,83.48,1,'C');
...
-- Survived: 1
-- Embarked: Q
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Elizabeth Taylor',31,'female',2,26.50,1,'Q');
...
-- Survived: 0
-- Embarked: Q
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Charles Anderson',19,'male',3,7.75,0,'Q');
...
-- Survived: 1
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Margaret Thomas',45,'female',1,120.00,1,'S');
...
-- Survived: 0
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('George Jackson',52,'male',2,30.00,0,'S');
...
-- Survived: 1
-- Embarked: C
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Sophia White',18,'female',3,10.50,1,'C');
...
-- Survived: 0
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Thomas Harris',29,'male',3,15.00,0,'S');
...
-- Survived: 1
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Emma Martin',36,'female',2,35.00,1,'S');
...
-- Survived: 1
-- Embarked: C
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Daniel Thompson',41,'male',1,90.00,1,'C');
...
-- Survived: 0
-- Embarked: Q
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Grace Garcia',27,'female',3,12.00,0,'Q');
...
-- Survived: 0
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Henry Martinez',60,'male',1,100.00,0,'S');
...
-- Survived: 1
-- Embarked: C
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Olivia Robinson',24,'female',2,28.00,1,'C');
...
-- Survived: 0
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('James Clark',33,'male',3,9.50,0,'S');
...
-- Survived: 1
-- Embarked: S
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Emily Rodriguez',30,'female',1,75.00,1,'S');
...
-- Survived: 0
-- Embarked: Q
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Edward Lewis',47,'male',2,32.00,0,'Q');
...
-- Survived: 1
-- Embarked: C
insert into passengers(name,age,gender,ticket_class,fare,survived,embarked) values('Charlotte Lee',26,'female',3,11.25,1,'C');
...
select name,gender,fare from passengers;

-- Q29. Display passenger names and ticket class.
select name,ticket_class from passengers;
...
select * from passengers where passenger_id=5;

-- Q31. Display the passenger named 'Mary Johnson'.
select * from passengers where name='Mary Johnson';
...
select * from passengers where gender='female';

-- Q34. Display all passengers whose gender is 'male'.
select * from passengers where gender='male';
...
select * from passengers where ticket_class=1;

-- Q38. Display all passengers travelling in ticket class 3.
select * from passengers where ticket_class=3;
...
select * from passengers where fare<20;

-- Q45. Display passengers whose fare is not equal to 10.50.
select * from passengers where fare<>10.50;
...
select * from passengers where gender='female' and survived=1;

-- Q48. Display male passengers who survived.
select * from passengers where gender='male' and survived=1;

-- Q49. Display passengers older than 30 and survived.
select * from passengers where age>30 and survived=1;
...
select * from passengers where ticket_class=1 and fare>50.00;

-- Q52. Display female passengers travelling in class 1.
select * from passengers where gender='female' and ticket_class=1;

-- Q53. Display male passengers travelling in class 3
--      and whose age is greater than 30.
select * from passengers where gender='male' and ticket_class=3 and age>30;
...
select * from passengers where gender='male' or gender='female';

-- Q55. Display passengers travelling in class 1 or class 2.
select * from passengers where ticket_class=1 or ticket_class=2;

-- Q56. Display passengers who embarked from S or C.
select * from passengers where embarked='S' or embarked='C';

-- Q57. Display passengers whose age is below 20 or above 50.
select * from passengers where age<20 or age>50;
...
--      using IN.
select * from passengers where ticket_class in (1,2);

-- Q59. Display passengers who embarked from S or C
--      using IN.
select * from passengers where embarked in ('S','C');

-- Q60. Display passengers whose age is 25, 30 or 40
--      using IN.
select * from passengers where age in (25,30,40);

-- Q61. Display passengers whose ticket class is not 1 or 3
--      using NOT IN.
select * from passengers where ticket_class not in (1,3);
...
select * from passengers where age between 20 and 30;

-- Q63. Display passengers whose age is between 30 and 50.
select * from passengers where age between 30 and 50;

-- Q64. Display passengers whose fare is between 20 and 50.
select * from passengers where fare between 20 and 50;

-- Q65. Display passengers whose fare is between 50 and 100.
select * from passengers where fare between 50 and 100;

-- Q66. Display passengers whose age is between 20 and 30
--      and who survived.
select * from passengers where age between 20 and 30 and survived=1;
...
--      from lowest to highest.
select * from passengers order by fare;
...
select * from passengers order by fare desc limit 1;

-- Q74. Display the passenger with the lowest fare.
select * from passengers order by fare limit 1;

-- Q75. Display the oldest passenger.
select * from passengers order by age desc limit 1;

-- Q76. Display the youngest passenger.
select * from passengers order by age limit 1;

-- Q77. Display the passenger with the second highest fare.
select * from passengers order by fare desc limit 1 offset 1;

-- Q78. Display the passenger with the second lowest fare.
select * from passengers order by fare limit 1 offset 1;

-- Q79. Display the three passengers with the highest fare.
select * from passengers order by fare desc limit 3;
...
select count(*) from passengers where gender='female';

-- Q92. Count the number of male passengers.
select count(*) from passengers where gender='male';
...
select avg(age) from passengers where gender='female';

-- Q96. Find the average age of male passengers.
select avg(age) from passengers where gender='male';

-- Q97. Find the average fare of passengers
--      travelling in class 1.
select avg(fare) from passengers where ticket_class=1;

-- Q98. Find the highest fare paid by a female passenger.
select max(fare) from passengers where gender='female';

-- Q99. Find the lowest fare paid by a male passenger.
select min(fare) from passengers where gender='male';
...
select * from passengers where fare = (select max(fare) from passengers);

-- Q101. Display the passenger who paid the lowest fare.
select * from passengers where fare = (select min(fare) from passengers);
...
select * from passengers where age = (select min(age) from passengers);
...
--       the average age.
select * from passengers where age > (select avg(age) from passengers);
...
select * from passengers where survived =1 and fare = (select max(fare) from passengers);

-- Q109. Display the passenger(s) who paid the lowest fare
--       among passengers who survived.
select * from passengers where survived =1 and fare = (select min(fare) from passengers);
...
select ticket_class,count(*) from passengers group by ticket_class;

-- Q112. Display the number of passengers from each
--       embarkation point.
select embarked,count(*) from passengers group by embarked;
...
select gender,avg(age) from passengers group by gender;

-- Q115. Display the average fare for each gender.
select gender,avg(fare) from passengers group by gender;

-- Q116. Display the total fare collected from each
--       ticket class.
select ticket_class,sum(fare) from passengers group by ticket_class;

-- Q117. Display the average fare for each ticket class.
select ticket_class,avg(fare) from passengers group by ticket_class;

-- Q118. Display the highest fare in each ticket class.
select ticket_class,max(fare) from passengers group by ticket_class;

-- Q119. Display the lowest fare in each ticket class.
select ticket_class,min(fare) from passengers group by ticket_class;

-- Q120. Display the number of survivors in each gender.
--
-- Hint:
-- Use GROUP BY and WHERE.
select gender,count(*) from passengers where survived=1 group by gender;
...
select ticket_class,count(*) as count from passengers group by ticket_class order by count desc;

-- Q122. Display each gender and the number of passengers,
--       ordered by count from highest to lowest.
select gender,count(*) as count from passengers group by gender order by count desc;

-- Q123. Display each embarkation point and the total fare
--       collected, ordered by total fare from highest
--       to lowest.
select embarked,sum(fare) as total from passengers group by embarked order by total desc;

-- Q124. Display each ticket class and its average fare,
--       ordered by average fare from highest to lowest.
select ticket_class,avg(fare) as average from passengers group by ticket_class order by average desc;

-- Q125. Display each gender and its average age,
--       ordered by average age from highest to lowest.
select gender,avg(age) as average from passengers group by gender order by average desc;
...
select ticket_class,count(*) as count from passengers group by ticket_class having count>5;

-- Q127. Display genders having more than 5 passengers.
select gender,count(*) as count from passengers group by gender having count>5;

-- Q128. Display embarkation points having more than 5 passengers.
select embarked,count(*) as count from passengers group by embarked having count>5;

-- Q129. Display ticket classes whose average fare is
--       greater than 30.
select ticket_class,avg(fare) as average from passengers group by ticket_class having average>30;

-- Q130. Display genders whose average age is greater than 30.
select gender,avg(age) as average from passengers group by gender having average>30;

-- Q131. Display ticket classes where the total fare is
--       greater than 100.
select ticket_class,sum(fare) as total from passengers group by ticket_class having total>100;

-- Q132. Display embarkation points where the total fare
--       collected is greater than 100.
select embarked,sum(fare) as total from passengers group by embarked having total>100;
...
select count(*) from passengers where ticket_class=1;

-- Q134. How many passengers travelled in third class?
select count(*) from passengers where ticket_class=3;

-- Q135. How many female passengers survived?
select count(*) from passengers where survived=1 and gender='female';

-- Q136. How many male passengers did not survive?
select count(*) from passengers where survived=0 and gender='male';

-- Q137. What is the average fare paid by survivors?
select avg(fare) from passengers where survived=1;

-- Q138. What is the average fare paid by passengers
--       who did not survive?
select avg(fare) from passengers where survived=0;

-- Q139. Find the highest fare paid by a passenger
--       who survived.
select max(fare) from passengers where survived=1;

-- Q140. Find the oldest female passenger.
select * from passengers where gender='female' order by age desc limit 1;

-- Q141. Find the oldest male passenger.
select * from passengers where gender='male' order by age desc limit 1;

-- Q142. Find the youngest passenger who survived.
select * from passengers where survived=1 order by age limit 1;

-- Q143. Find the highest-paid female passenger.
select * from passengers where gender='female' order by fare desc limit 1;

-- Q144. Find the highest-paid male passenger.
select * from passengers where gender='male' order by fare desc limit 1;

-- Q145. Display passengers who are female, survived,
--       and paid a fare greater than 30.
select * from passengers where gender='female' and survived=1 and fare>30;

-- Q146. Display passengers who are male, did not survive,
--       and are older than 30.
select * from passengers where gender='male' and survived=0 and age>30;

-- Q147. Display passengers travelling in class 1 or class 2
--       who survived.
select * from passengers where survived=1 and ticket_class in (1,2);

-- Q148. Display passengers travelling in class 3 whose
--       fare is below 20.
select * from passengers where ticket_class=3 and fare<20;

-- Q149. Display passengers whose age is between 20 and 40
--       and whose fare is greater than 25.
select * from passengers where fare>25 and age between 20 and 40;

-- Q150. Find the ticket class having the highest
--       number of passengers.
select ticket_class,count(*) from passengers group by ticket_class limit 1;
